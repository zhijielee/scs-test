...
public class TestGitOfStudent {
  ...
  public TestGitOfStudent (String studentNumber, String studentName, String gitUrl) {
      this.studentNumber = studentNumber;
      this.password = studentNumber.substring(4);
  ...
  @Test
  public void testGitOfStudent() throws Exception {
    driver.get(baseUrl + "/login");
    WebElement studentNum = driver.findElement(By.name("id"));
//    we.click();
//    driver.findElement(By.id("kw")).click();
    studentNum.sendKeys(this.studentNumber);
    WebElement studentPassword = driver.findElement(By.name("password"));
    studentPassword.sendKeys(this.password);
    driver.findElement(By.id("btn_login")).click();
    assertEquals(this.studentNumber, driver.findElement(By.id("student-id")).getText());
    assertEquals(this.studentName, driver.findElement(By.id("student-name")).getText());
    assertEquals(this.gitUrl, driver.findElement(By.id("student-git")).getText());
}
